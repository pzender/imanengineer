...
namespace TV_App.Services
{
    public class ProgrammeService
    {
        ...
        public IEnumerable<ProgrammeDTO> GetFilteredProgrammes(Filter filter = null, string user = null)
        {
            ...
            LogService.Log($"{result.Count()} programmes after filter; {programmes.Count} before filter");
            return result;
        }
        ...
        public IEnumerable<ProgrammeDTO> GetRatedBy(string username)
        {
            ...
            Console.WriteLine($"{result.Count()} programmes after filter; {programmes.Count} before filter");
            return result;
        }
        ...
        public IEnumerable<Feature> GetFeatures(string term)
        {
            return db.Features
                .Include(f => f.RelType)
                .Where(f => f.Value.Contains(term))
                .AsNoTracking();
        }
    }
}
